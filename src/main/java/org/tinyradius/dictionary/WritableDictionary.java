...
extends Dictionary {
     ...
     * //@param sizeAttrCode the number of bytes for the vendor specific attribute code.
     * //@param sizeAttrLen the number of bytes for the vendor specific attribute len.
	 */
